Implementar la función `esCuadradoPerfecto/1`, que responda si un numero es un [cuadrado perfecto](http://es.wikipedia.org/wiki/Cuadrado_perfecto), sin hacer operaciones con punto flotante.
